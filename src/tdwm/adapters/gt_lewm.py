"""Stable World Model adapter for the standalone GT-LeWM method."""
...
from tdwm.methods.goal_tail import GoalTailValue, discounted_goal_tail_target


class GoalTailLeWM(nn.Module):
    """Wrap a public LeWM model with a goal-conditioned terminal tail value."""
    ...
    def get_cost(
        ...
        """Score CEM candidates with path cost plus terminal value bootstrap."""
...
def load_goal_tail_value(
    ...
    """Load the value-head export written by the standalone GT-LeWM trainer."""
...
def make_goal_tail_policy(
    *,
    ...
    """Build Stable World Model's CEM policy around the standalone adapter."""
