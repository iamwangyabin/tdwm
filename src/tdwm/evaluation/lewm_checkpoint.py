...
def _prepare_pyarrow_hotfix() -> dict[str, str] | None:
    """Allow the cloud image's old pyarrow-hotfix to import on new PyArrow."""
    ...
    try:
        ...
        return None
    if int(pyarrow_version.split(".", 1)[0]) < 21 or hotfix_version != "0.6":
        return None
...
def evaluate_official_lewm(
    *,
    ...
    compatibility = _prepare_pyarrow_hotfix()
