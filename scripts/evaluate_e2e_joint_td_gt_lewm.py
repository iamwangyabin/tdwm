...
from tdwm.evaluation.e2e_joint_td_gt_lewm import evaluate_e2e_joint_td_gt_lewm


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate E2E Joint TD-GT-LeWM with unchanged Cube CEM."
    )
...
def main() -> None:
    ...
    if output_dir is None:
        output_dir = (
            ...
            / "e2e_joint_td_gt_lewm_cube_evaluation"
        )
    result = evaluate_e2e_joint_td_gt_lewm(
